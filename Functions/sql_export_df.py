def sql_export_df(df_name, what_is_sql_file_name, what_is_sql_file_dir = cwd, save_to_where_default_download_folder = path_to_download_folder):
...
""".format(start_time_now, what_is_sql_file_name,what_is_sql_file_dir)
    ...
    try:
        ...
        with mydb.cursor() as cursor:
            ...
            df_name = pd.DataFrame(myresult, columns=columns)
