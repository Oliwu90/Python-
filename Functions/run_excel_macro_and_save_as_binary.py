def run_excel_macro_and_save_as_binary (file_path_with_extension , VBA_macro_name, VBA_procedure_name, saved_path):
        """
        ...
        try:
                ...
                print("'" + file_path_with_extension.split(sep=os.sep)[-1] + "'" + "!" + VBA_macro_name + "." + VBA_procedure_name)
                time.sleep(3)
                ...
                wb.SaveAs(Filename=saved_path + "\\" + workbook_name + today, FileFormat=50)
